...
<@CommonQueryMacro.page title="签约信息">
	<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOverseaLendingTabs" navigate="false" currentTab="BOPForDebtOverseaLendingChangeInfo">
	...
	<script language="JavaScript">
		...
		{	
			...
			changFileType = "AC";
			BOPForDebtChangeInfo_dataset.setParameter("changFileType","AC");
		}
		...
		function btNewClick(){
			...
			showWin("境外同业拆借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOverseaLendingChangeInfoCol.ftl?op=new&changFileType="+changFileType,"report","flushPage()");
		...
		function doModify(id) {
		    locate(id);
			showWin("境外同业拆借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOverseaLendingChangeInfoCol.ftl?id="+id+"&op=mod&changFileType="+changFileType,"report","flushPage()");
		}

		//删除
		function doDelete(id) {
		    locate(id);
			showWin("境外同业拆借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOverseaLendingChangeInfoCol.ftl?id="+id+"&op=del&changFileType="+changFileType,"report","flushPage()");
		}
