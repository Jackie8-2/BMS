						...
						<table frame=void class="grouptable" width="100%">
							<tr>
								...
								<td class="datatd"><@CommonQueryMacro.SingleField
									fId="exdebtcode"/><input id="loadLoanButton" extra="button" style='width=25px;height=17px;' onclick="loadLoan();" type='button' value='...'/></td>
...
<script language="javascript">
	...
	function loadLoan(){
		...
		showPickup("买方信贷签约信息","${contextPath}/fpages/datacollection/ftl/winloadpage/BopCfaDebtBiLoanLoadPage.ftl?currentFile=AB");
