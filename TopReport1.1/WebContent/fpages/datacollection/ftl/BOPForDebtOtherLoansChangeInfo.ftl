...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOtherLoansTabs" navigate="false" currentTab="BOPForDebtOtherLoansChangeInfo">
...
<script language="JavaScript">
	...
	function initCallGetter_post()
	{
		...
		changFileType = "AI";
		BOPForDebtChangeInfo_dataset.setParameter("changFileType","AI");
	}
	...
	function btNewClick(){                 
		...
		showWin("其他贷款变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?op=new&changFileType="+changFileType,"report","flushPage()");
	
	}
	//详细
	function doDetail(id) {
		locate(id);
		showWin("其他贷款变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?id="+id+"&op=detaile&changFileType="+changFileType,"report","flushPage()");
	}
	...
	function doModify(id) {
	    locate(id);
		showWin("其他贷款变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?id="+id+"&op=mod&changFileType="+changFileType,"report","flushPage()");
	}

	//删除
	function doDelete(id) {
	    locate(id);
		showWin("其他贷款变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?id="+id+"&op=del&changFileType="+changFileType,"report","flushPage()");
	}
