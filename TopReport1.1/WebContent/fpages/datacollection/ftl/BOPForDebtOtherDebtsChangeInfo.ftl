...
<@CommonQueryMacro.page title="签约信息">
	<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOtherDebtsTabs" navigate="false" currentTab="BOPForDebtOtherDebtsChangeInfo">
	...
	<script language="JavaScript">
		...
		function initCallGetter_post() {
			...
			changFileType = "AQ";
			BOPForDebtChangeInfo_dataset.setParameter("changFileType","AQ");
		}
		...
		//新增
		function btNewClick(){
			showWin("其他外债变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherDebtsChangeInfoCol.ftl?op=new&changFileType="+changFileType,"report","flushPage()");
		}
		//详细
		function doDetail(id) {
			showWin("其他外债变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherDebtsChangeInfoCol.ftl?id="+id+"&op=detaile&changFileType="+changFileType,"report","flushPage()");
		}
		//修改
		function doModify(id) {
			showWin("其他外债变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherDebtsChangeInfoCol.ftl?id="+id+"&op=mod&changFileType="+changFileType,"report","flushPage()");
		}
		//删除
		function doDelete(id) {
			showWin("其他外债变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherDebtsChangeInfoCol.ftl?id="+id+"&op=del&changFileType="+changFileType,"report","flushPage()");
		}
		//刷新数据
		function flushPage(){
