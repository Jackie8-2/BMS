...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtCurrMarketToolsTabs" navigate="false" currentTab="BOPForDebtCurrMarketToolsChangeInfo">
...
<script language="JavaScript">
	...
	function initCallGetter_post()
	{
		...
		changFileType = "AJ";
		BOPForDebtChangeInfo_dataset.setParameter("changFileType","AJ");
	}
	...
	function btNewClick(){                 
		...
		showWin("货币市场工具变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtCurrMarketToolsChangeInfoCol.ftl?op=new&changFileType="+changFileType,"report","flushPage()");
	
	}
	//详细
	function doDetail(id) {
		locate(id);
		showWin("货币市场工具变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtCurrMarketToolsChangeInfoCol.ftl?id="+id+"&op=detaile&changFileType="+changFileType,"report","flushPage()");
	}
	...
	function doModify(id) {
	    locate(id);
		showWin("货币市场工具变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtCurrMarketToolsChangeInfoCol.ftl?id="+id+"&op=mod&changFileType="+changFileType,"report","flushPage()");
	}

	//删除
	function doDelete(id) {
	    locate(id);
		showWin("货币市场工具变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtCurrMarketToolsChangeInfoCol.ftl?id="+id+"&op=del&changFileType="+changFileType,"report","flushPage()");
	}
