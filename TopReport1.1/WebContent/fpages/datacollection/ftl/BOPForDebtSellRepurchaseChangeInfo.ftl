...
<@CommonQueryMacro.page title="变动信息">
	<@CommonQueryMacro.CommonQueryTab id="BOPForDebtSellRepurchaseTabs" navigate="false" currentTab="BOPForDebtSellRepurchaseChangeInfo">
	...
	<script language="JavaScript">
		...
		function initCallGetter_post()
		{
			...
			changFileType = "AE";
			BOPForDebtChangeInfo_dataset.setParameter("changFileType","AE");
		}
		...
		//新增
		function btNewClick(){
			showWin("卖出回购变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtSellRepurchaseChangeInfoCol.ftl?op=new&changFileType="+changFileType,"report","flushPage()");
		}
		//详细
		function doDetail(id) {
			locate(id);
			showWin("卖出回购变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtSellRepurchaseChangeInfoCol.ftl?id="+id+"&op=detaile&changFileType="+changFileType,"report","flushPage()");
		}
		...
		function doModify(id) {
		    locate(id);
			showWin("卖出回购变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtSellRepurchaseChangeInfoCol.ftl?id="+id+"&op=mod&changFileType="+changFileType,"report","flushPage()");
		}

		//删除
		function doDelete(id) {
		    locate(id);
			showWin("卖出回购变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtSellRepurchaseChangeInfoCol.ftl?id="+id+"&op=del&changFileType="+changFileType,"report","flushPage()");
		}
	</script>
