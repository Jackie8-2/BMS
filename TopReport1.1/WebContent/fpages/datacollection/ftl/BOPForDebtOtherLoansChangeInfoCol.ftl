						...
						<td>
							<@CommonQueryMacro.GroupBox id="guoup1" label="签约信息" expand="true">
								<table frame=void class="grouptable" width="100%">
									...
									<tr>
										<td align="center" nowrap class="labeltd">项目名称</td>
										<td class="datatd" colspan="4"><@CommonQueryMacro.SingleField fId="projectname"/></td>
									</tr>
								</table>
...
<script language="javascript">
	...
	//弹出账户信息选择框
	function loadLoan(){
		showPickup("其他贷款签约信息","${contextPath}/fpages/datacollection/ftl/winloadpage/BopCfaDebtBiLoanLoadPage.ftl?currentFile=AI");
	}
