...
<script language="javascript">
	...
	function initCallGetter_post() {
		if("new" != op) {
			...
			//if (approveStatus == "00") {
			//	document.getElementById("approveHref").href="#";
	...
	//弹出账户信息选择框
	function loadLoan(){
		showPickup("债券和票据签约信息","${contextPath}/fpages/datacollection/ftl/winloadpage/BopCfaDebtBiLoanLoadPage.ftl?currentFile=AK");
	}
