...
<@CommonQueryMacro.page title="BOPForDebtBilLoan.title">
								...
								<@CommonQueryMacro.GroupBox id="guoup1" label="签约信息" expand="true">
									<table frame=void class="grouptable" width="100%">
										...
										<tr>
											...
											<td class="datatd"><@CommonQueryMacro.SingleField fId="qFiller2"/></td>
										</tr>
									</table>
	...
	<script language="javascript">
		...
		//弹出账户信息选择框
		function loadLoan(){
			showPickup("货币市场工具签约信息","${contextPath}/fpages/datacollection/ftl/winloadpage/BopCfaDebtBiLoanLoadPage.ftl?currentFile=AJ");
