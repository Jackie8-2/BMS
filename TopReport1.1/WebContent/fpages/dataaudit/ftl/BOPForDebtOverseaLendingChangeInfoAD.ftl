...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOverseaLendingADTabs" navigate="false" currentTab="BOPForDebtOverseaLendingChangeInfoAD">
...
<script language="JavaScript">
	...
	{
		changFileType = "AC";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AC");
		//工作日期
	...
	function doDetail(id){
		showWin("外债境外同业拆借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOverseaLendingChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
