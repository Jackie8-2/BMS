...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtBuyerADTabs" navigate="false" currentTab="BOPForDebtBuyerChangeInfoAD">
...
<script language="JavaScript">
	...
	function initCallGetter_post()
	{
		...
		changFileType = "AB";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AB");
	}
	...
	function doDetail(id){
		showWin("外债买方信贷变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtBuyerChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
