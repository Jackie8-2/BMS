...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtUsanceLeOfCreditADTabs" navigate="false" currentTab="BOPForDebtUsanceLeOfCreditChangeInfoAD">
	<@CommonQueryMacro.CommonQuery id="BOPForDebtChangeInfoVer" init="false" submitMode="selected" navigate="false" >
		<table align="left">
		    ...
		    <tr>
		    	<td>
					<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="btAudit" fieldStr="select[40],filler2,workDate[100],actiontype[80],recStatus[80],approveStatus[80],repStatus[80],exdebtcode[190],buscode[120],changeno[80],changtype[120],chdate[120],chcurrency[140],chamount[120],fairvalue[120]" hasFrame="true" width="900" height="260" readonly="true"/>
		      	</td>
		    </tr>
...
<script language="JavaScript">
	...
	{
		changFileType = "AF";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AF");
		//工作日期
	...
	function doDetail(id){
		showWin("远期信用证变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtRefinancingChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
