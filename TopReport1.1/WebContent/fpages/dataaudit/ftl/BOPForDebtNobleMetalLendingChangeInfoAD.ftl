...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtNobleMetalLendingADTabs" navigate="false" currentTab="BOPForDebtNobleMetalLendingChangeInfoAD">
...
<script language="JavaScript">
	...
	{
		changFileType = "AH";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AH");
		//工作日期
	...
	function doDetail(id){
		showWin("贵金属拆借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtNobleMetalLendingChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
