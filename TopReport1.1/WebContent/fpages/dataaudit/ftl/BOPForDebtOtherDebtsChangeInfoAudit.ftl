...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOtherDebtsAuditTabs" navigate="false" currentTab="BOPForDebtOtherDebtsChangeInfoAudit">
...
<script language="JavaScript">
	...
	{
		changFileType = "AQ";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AQ");
		//工作日期
	...
	function doDetail(id){
		showWin("其他外债借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
