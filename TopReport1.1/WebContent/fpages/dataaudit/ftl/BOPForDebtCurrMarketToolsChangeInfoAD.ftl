...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtCurrMarketToolsADTabs" navigate="false" currentTab="BOPForDebtCurrMarketToolsChangeInfoAD">
...
<script language="JavaScript">
	...
	{
		changFileType = "AJ";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AJ");
		//工作日期
	...
	function doDetail(id){
		showWin("货币市场工具变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtCurrMarketToolsChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
