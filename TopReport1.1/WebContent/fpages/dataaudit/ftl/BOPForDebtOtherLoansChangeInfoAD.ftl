...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOtherLoansADTabs" navigate="false" currentTab="BOPForDebtOtherLoansChangeInfoAD">
...
<script language="JavaScript">
	...
	{
		changFileType = "AI";
		BOPForDebtChangeInfoVer_dataset.setParameter("changFileType","AI");
		//工作日期
	...
	function doDetail(id){
		showWin("其他贷款借变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtOtherLoansChangeInfoCol.ftl?id=" + id + "&op=detaile");
	}
</script>
