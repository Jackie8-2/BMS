...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtBuyerQueryTabs" navigate="false" currentTab="BOPForDebtbuyerChangeInfoQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AB");
