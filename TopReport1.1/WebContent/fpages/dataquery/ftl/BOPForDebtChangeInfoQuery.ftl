...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtQueryTabs" navigate="false" currentTab="BOPForDebtChangInfoQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AA");
...
//	}
	...
	//	locate(id);
	//	showWin("双边贷款变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtChangeInfoCol.ftl?id="+id+"&op=detaile&model=Query","report","flushPage()");
	//}

	//详细
	function doDetail(id) {
		var changFileType = "AA";
