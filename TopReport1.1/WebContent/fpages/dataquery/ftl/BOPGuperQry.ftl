...
<@CommonQueryMacro.page title="履约明细信息">
	<@CommonQueryMacro.CommonQueryTab id="BopCFAExguQryTabs" navigate="false" currentTab="BOPGuperQry">
		<@CommonQueryMacro.CommonQuery id="BOPGuperQry" init="false" submitMode="selected" navigate="false" >
			<table align="left">
				<tr>
					<td colspan="2">
	...
	function initCallGetter_post() {
		...
		BOPGuperQry_interface_dataset.setValue("qWorkDateStart","${v_txdate}");
		BOPGuperQry_interface_dataset.setValue("qWorkDateEnd","${v_txdate}");
	}
