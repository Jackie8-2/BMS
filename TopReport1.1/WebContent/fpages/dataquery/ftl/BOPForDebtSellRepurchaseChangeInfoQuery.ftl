...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtSellRepurchaseQueryTabs" navigate="false" currentTab="BOPForDebtSellRepurchaseChangeInfoQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AE");
