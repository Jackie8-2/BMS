...
<@CommonQueryMacro.CommonQueryTab id="bOPForDebtCurrMarketQueryTabs" navigate="false" currentTab="BOPForDebtCurrMarketChangeQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AJ");
