...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtOtherDebtsQueryTabs" navigate="false" currentTab="BOPForDebtOtherDebtsChangeInfoQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AQ");
