...
<@CommonQueryMacro.CommonQueryTab id="BOPForDebtRefinancingQueryTabs" navigate="false" currentTab="BOPForDebtRefinancingChangeInfoQuery">
...
<script language="JavaScript">
	...
	{
		BOPForDebtChangeInfoQuery_dataset.setParameter("changFileType","AD");
...
//	}
	...
	//	locate(id);
	//	showWin("海外代付变动信息","${contextPath}/fpages/datacollection/ftl/BOPForDebtRefinancingChangeInfoCol.ftl?id="+id+"&op=detaile&model=Query","report","flushPage()");
	//}

	//详细
	function doDetail(id) {
		var changFileType = "AD";
