	...
	<table align="left">
			<tr>
        		...
        		<td align="left" valign="top" width="200">
        			<@CommonQuery.Group id="group1" label="操作员信息1" fieldStr="brcode,tlrno,tlrnoName,status,latelyLogoutTime,latelyLoginTime,effectDate,expireDate,email,misc,creatDate" colNm=4/>
