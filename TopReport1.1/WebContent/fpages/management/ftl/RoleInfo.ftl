...
<@CommonQueryMacro.page title="岗位权限设置">
<table align="left">
			...
			<tr>
        		...
        		<td align="left" valign="top" width="200">
        			<table align="center">
        				<tr>
       					<td>
        					<@CommonQueryMacro.Group id="group1" label="岗位权限设置" fieldStr="roleid,rolename,roletype,status,effectDate,expireDate" colNm=2/>
        				</td>
						</tr>
						<tr align="center">
       					<td>
