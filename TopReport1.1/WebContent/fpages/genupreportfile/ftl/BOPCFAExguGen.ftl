...
<@CommonQueryMacro.CommonQueryTab id="BopCFAExguGenTabs" navigate="false" currentTab="BOPCFAExguGen">
	<@CommonQueryMacro.CommonQuery id="BOPCFAExguGen" init="false" submitMode="selected" navigate="false" >
		<table align="left">
			<tr>
				<td colspan="2">
...
function doDetail(id){
	...
	showWin("签约信息信息明细","${contextPath}/fpages/datacollection/ftl/BopForCFAExguDsAdd.ftl?id=" + id + "&op=detail");
}
</script>
