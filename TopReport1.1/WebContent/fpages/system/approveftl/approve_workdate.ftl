...
<#--jianxue.zhang-->
<@CommonQueryMacro.page title="工作日期维护审批">
<table width="800px" align="left">
 <tr>
 <td>
<@CommonQueryMacro.CommonQuery id="approve_workdate" init="true"  navigate="true" submitMode="all">
 <FIELDSET name='intface' style="padding: 8px;"><LEGEND>&nbsp;待审批工作日期维护列表&nbsp;</LEGEND>
<@CommonQueryMacro.DataTable id ="datatable1" fieldStr="id,workdateYear,crtDt,updTransCd" width="100%" readonly="true" hasFrame="true" />	
 </FIELDSET>
...
function btApprove_onClickCheck(button){
	approve_common_dataset.setValue("intInsId","100599");
	return true;
}
</script>
