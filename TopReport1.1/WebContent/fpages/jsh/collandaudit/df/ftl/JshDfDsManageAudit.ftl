...
<@CommonQueryMacro.CommonQueryTab id="JshDfDsAuditTabs" navigate="false" currentTab="JshDfDsManageAudit">
<table width=""><tr><td>
	<@CommonQueryMacro.CommonQuery id="JshDfDsManageAudit" init="false" submitMode="selected" navigate="false" >
		<table align="left">
			<tr>
				<td colspan="2">
		    ...
		    <tr>
		    	<td colspan="2">
					<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="btAudit" fieldStr="select[100],filler2[80],buscode[100],brNo[80],brNoName[80],workDate[100],recStatus[80],approveStatus[80],repStatus[80],actiontype[80],actiondesc[100],rptno[100],txcode[80],usetype[80],usedetail[150],crtuser[80],inptelc[100],rptdate[80]" hasFrame="true" width="900" height="260" readonly="true"/>
		      	</td>
		    </tr>
...
<script language="JavaScript">
	var ds = JshDfDsManageAudit_dataset;
	function initCallGetter_post() {
		//工作日期
		<#assign v_txdate = statics["com.huateng.ebank.business.common.GlobalInfo"].getCurrentInstance().getTxdate()>
		JshDfDsManageAudit_interface_dataset.setValue("qworkDateStart","${v_txdate}");
		JshDfDsManageAudit_interface_dataset.setValue("qworkDateEnd","${v_txdate}");
	}
